...
void Engine::initDispatchLoader() {
...
void Engine::initWindow() {
  ...
  glfwSetFramebufferSizeCallback(window_, Engine::framebufferResizeCallback);
...
vk::DebugUtilsMessengerCreateInfoEXT Engine::getDebugMessengerCreateInfo() {
